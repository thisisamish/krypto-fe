// src/app/pages/orders/order-history.component.ts
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr *ngFor="let order of orders" class="hover:bg-gray-50">
                <td
                  class="px-6 py-4 whitespace-nowrap text-sm font-medium text-blue-600 cursor-default"
                >
                  {{ order.orderNumber }}
                </td>
...
export class OrderHistoryComponent implements OnInit {
  ...
  loadOrders(): void {
    this.loading = true;
    this.error = null;
    this.orderService.list(this.currentPage, this.pageSize).subscribe({
      next: (response) => {
